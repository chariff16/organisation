<?php
  if ((isset($_GET['ClassId']))) {
    require('../dbcon.php');
    $id = mysqli_real_escape_string($con, $_GET['ClassId']);
  }else {
    header("location: ../index.html");
  }
  require("../dbcon.php");
  $sql1 = "SELECT * FROM `user` WHERE `group` = $id ";
  $run1 = mysqli_query($con, $sql1);
  $student_nbr = mysqli_num_rows( $run1 );
?>
<!DOCTYPE html>
<html dir="rtl" lang="ar">
  ...
  <body>
    ...
    <section class="d-flex">
      ...
      <main>
        <div>
          <h3 class="text-primary text-center mt-3">معلومات القسم</h3>
        </div>
        <div class="mt-3 mx-5">
          <div class="mt-4">
            <h3>عدد الطلبة : <?php echo $student_nbr ?></h3>
          </div>
          <div class="mt-4">
            <table class="table table-hover" id="table">
              ...
              <tbody>
                <?php
                  require("../dbcon.php");
                  $sql = "SELECT * FROM `user` WHERE `group` = $id ";
